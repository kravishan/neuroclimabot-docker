...
async def process_with_translation(
    ...
    **orchestrator_kwargs
    ...
    """
    Centralized translation workflow for chat endpoints.

    Workflow:
    1. Detect input language and translate to English
    2. Process with RAG pipeline (always in English)
...
async def process_with_translation_and_tracing(
    ...
    **orchestrator_kwargs
    ...
    """
    Centralized translation workflow with Langfuse tracing.
